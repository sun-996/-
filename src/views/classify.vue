  ...
  <div class="panel">
    <div class="panel-title">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item to="/classify">产品管理</el-breadcrumb-item>
    ...
    >
      ...
      <el-table-column prop="orderid" label="序号" width="100" sortable></el-table-column>
    ...
    <el-dialog :title="flag+'产品分类'" :visible.sync="show" width="500px">
      <el-form
        ref="form"
        :model="form"
        :rules="rules"
...
export default {
  ...
  methods: {
    fetch() {
      this.$http.get("/api/classify/list.php").then(res => {
    ...
    handleDel(id) {
      ...
      this.$http.post("/api/classify/del.php", param).then(res => {
      ...
      this.$refs.form &&
        this.$refs.form.validate(vali => {
          if (vali) {
            ...
            //添加和修改处理
            let url = {
              添加: "/api/classify/add.php",
              修改: "/api/classify/edit.php"
            };
    ...
    stateChange(state, id) {
      ...
      param.append("id", id);
      this.$http.post("/api/classify/state.php", param).then(res => {
        if (res.data.code !== 20000) {
          this.$message.error(res.data.desc);
        }
      });
